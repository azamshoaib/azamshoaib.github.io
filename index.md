...
- **[Jan. 2021]** Our N<sup>2</sup>C: Neural Network Controller Design Using Behavioral Cloning is accepted to IEEE Transactions on Intelligent Transportation Systems (IF:6.492).
...
- **N<sup>2</sup>C: Neural Network Controller Design Using Behavioral Cloning**
  <br>
...
- **Object Modeling from 3D Point Cloud Data for Self-Driving Vehicles**
  <br>
  **Shoaib Azam**, Farzeen Munir, Aasim Raﬁque, YeongMin Ko, Ahmad Muqeem Sheri and Moongu Jeon
  <br>
...
- **Developement of Autonomous vehicle (Supported by: GIST)**
  - Architecture
    ![](./assets/img/archi.png)
  - Sensor Suite 
    ![](./assets/img/suite.png)
  - Demostrations
    - Complete autonomous drive
    [![Watch this video](./assets/img/demo1.png)](https://drive.google.com/file/d/1xN2NNb0rYyeUtqZMFgqEfe7EIUv9iwDC/view?usp=sharing)
    - Demo of Obstacle Avoidance
    [![Watch this video](./assets/img/demo2.png)](https://drive.google.com/file/d/1BGeER14V7pgTj8CincAt5Jm3OcYvn4m9/view?usp=sharing)
    - Demo of Obstacle Stopping
    [![Watch this video](./assets/img/demo3.png)](https://drive.google.com/file/d/15mMNkcgGU_eFj0iAwPalE2pDZaZhqOuc/view?usp=sharing)
    - Demo of Obstacle Stopping at the Entrance or Exit Gate Barrier
    [![Watch this video](./assets/img/demo4.png)](https://drive.google.com/file/d/1GoOiLMI0Ne16JOBCteDC4G72qwT8bMa8/view?usp=sharing)
    - Demo of Obstacle Detection using RGB and Thermal Camera and Projection in the Lidar Frame
    [![Watch this video](./assets/img/demo5.png)](https://drive.google.com/file/d/1zq28YVLr_6H-OdbA-GeahQ3-9g_XP67B/view?usp=sharing)
    - Demo of Obstacle Stopping upon detection pedestrain
    [![Watch this video](./assets/img/demo6.png)](https://drive.google.com/file/d/17FLmhs2P8n3LQryanGCRHXkgtrJJsbiA/view?usp=sharing)
